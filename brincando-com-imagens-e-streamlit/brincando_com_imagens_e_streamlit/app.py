...
if uploaded_file is not None:
    ...
    def quantify(option, ch):
        aux = (256 / ch)
        for channel in range(ch):
            if channel == 0:
                option[option <= aux] = 0
            elif channel == ch - 1:
                option[option >= (aux * channel)] = 255
            else:
                option[(option > ((channel * aux) - 1)) & (option < ((channel + 1) * aux))] = aux * channel
    ...
    # elif option == 16:
    #     image_aux[image_aux > 255] = 255
    #     image_aux[(image_aux > 223) & (image_aux < 256)] = 224
    #     image_aux[(image_aux > 207) & (image_aux < 224)] = 208
    #     image_aux[(image_aux > 191) & (image_aux < 208)] = 192
    #     image_aux[(image_aux > 175) & (image_aux < 192)] = 176
    #  etc...
